...
public class DemoTinyZValues extends AbstractAnalysis {

    public static void main(String[] args) throws Exception {
        AnalysisLauncher.open(new DemoTinyZValues());
    }
    ...
    public void init() {
        try {
            ...
            Logger.getLogger(DemoTinyZValues.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
