...
public class DemoSmallValuesMulDemul extends AbstractAnalysis {

    public static void main(String[] args) throws Exception {
        AnalysisLauncher.open(new DemoSmallValuesMulDemul());
    }
    ...
    public void init() {
        try {
            ...
            Logger.getLogger(DemoSmallValuesMulDemul.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
