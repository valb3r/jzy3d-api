...
public class DemoSmallValuesNormalize extends AbstractAnalysis {

    public static void main(String[] args) throws Exception {
        AnalysisLauncher.open(new DemoSmallValuesNormalize());
    }
    ...
    public void init() {
        try {
            ...
            Normalizer.Model m = Normalizer.normalize(coords);
            ...
            Logger.getLogger(DemoSmallValuesNormalize.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
